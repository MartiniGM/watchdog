...
with con:
    ...
    cur.execute("CREATE TABLE GOOGLESHEET_BACKUP (IP_ADDRESS TEXT PRIMARY KEY, MAC_ADDRESS TEXT, HOSTNAME TEXT, DEVICE_NAME TEXT, DEVICE_TYPE TEXT, ZONE TEXT, SPACE TEXT, LOCATION TEXT, DESCRIPTION TEXT, FLOW_CHART_LINK TEXT, GS_ORDER TEXT, SWITCH_INTERFACE TEXT)")
